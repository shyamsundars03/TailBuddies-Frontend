                        ...
                        <div className="space-y-4 w-full">
                            ...
                            <div className="relative group">
                                <div className="absolute left-4 top-4 flex flex-col gap-2">
                                    <button className="p-2 bg-gray-50 text-gray-400 rounded-xl hover:bg-blue-50 hover:text-blue-600 transition-all active:scale-90 shadow-sm border border-transparent hover:border-blue-100">
                                ...
                                <textarea
                                    className="w-full h-40 bg-white border-2 border-gray-50 rounded-3xl p-5 pl-16 text-sm font-medium focus:outline-none focus:border-blue-500 shadow-sm transition-all text-black"
                                    placeholder="Type pet's symptoms or behavior... you can also attach photos or reports."
