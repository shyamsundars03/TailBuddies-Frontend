...
import { DoctorPageContainer } from "../common/layout/doctor/PageContainer"
                                    ...
                                    >
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <span
                                                    className={`inline-block mt-1 px-3 py-1 text-xs font-medium rounded-full ${apt.status === "Confirmed" ? "bg-blue-100 text-blue-700" : "bg-yellow-100 text-yellow-700"
                                                        }`}
                                                >
                                                    {apt.status}
                                                </span>
