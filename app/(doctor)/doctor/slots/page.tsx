        ...
        <div className="w-full space-y-8">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                    <h2 className="text-xl font-bold font-inter text-black">Select Date</h2>
                    <div className="flex flex-wrap items-center gap-4">
                        <div className="flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 rounded-lg text-xs font-bold text-gray-600">
                            <CalendarIcon size={14} className="text-blue-600" />
                            <span>08/04/2020 - 08/11/2020</span>
                        </div>
                        <button className="flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 rounded-lg text-xs font-bold text-gray-600">
                    ...
                    <div className="pt-10 border-t border-gray-100">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                            <div>
                                ...
                                <div className="flex gap-2">
                                    <div className="relative flex-1">
                                        <select className="w-full pl-4 pr-8 py-3 border border-gray-200 rounded-lg text-xs font-black bg-white appearance-none text-black"><option>hour</option></select>
                                        <ChevronDown size={14} className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none" />
                                    </div>
                                    <div className="relative flex-1">
                                        <select className="w-full pl-4 pr-8 py-3 border border-gray-200 rounded-lg text-xs font-black bg-white appearance-none text-black"><option>min</option></select>
                                        <ChevronDown size={14} className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none" />
                                    </div>
                                </div>
                            </div>
                            <div>
                                <label className="text-[10px] font-black uppercase text-gray-400 block mb-3 tracking-widest">End Time *</label>
                                <div className="flex gap-2">
                                    <div className="relative flex-1">
                                        <select className="w-full pl-4 pr-8 py-3 border border-gray-200 rounded-lg text-xs font-black bg-white appearance-none text-black"><option>hour</option></select>
                                        <ChevronDown size={14} className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none" />
                            ...
                            <div>
                                ...
                                <input type="text" placeholder="Per Meet" className="w-full px-4 py-3 border border-gray-200 rounded-lg text-xs font-black bg-white placeholder:text-gray-300 text-black" />
                            </div>
                        </div>
