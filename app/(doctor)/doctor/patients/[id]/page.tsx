        ...
        <div className="w-full">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                ...
                <div className="flex items-center justify-between mb-10">
                    <h2 className="text-2xl font-bold font-inter text-gray-900">Patient Detail</h2>
                    <button
                        onClick={() => router.back()}
                ...
                <div className="flex flex-col md:flex-row gap-10 mb-12 text-black">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                    ...
                    <div className="lg:col-span-2 space-y-10">
                        <section>
                            <h4 className="text-xl font-bold mb-6 font-inter underline decoration-[#FED141] decoration-4 underline-offset-8 text-black">Visit History</h4>
                            <div className="space-y-4">
                                {patient.history.map((visit, i) => (
                                    <div key={i} className="flex items-center gap-4 bg-white border border-gray-100 p-5 rounded-2xl hover:shadow-md transition">
                                        ...
                                        <div className="flex-1">
                                            <h5 className="text-base font-bold mb-1 text-black">{visit.type}</h5>
                    ...
                    <div className="space-y-10">
                        <section>
                            <h4 className="text-xl font-bold mb-6 font-inter text-black">Recent Vitals</h4>
                        ...
                        <section>
                            <h4 className="text-xl font-bold mb-6 font-inter text-black">Medical Documents</h4>
