...
export default function DoctorChatListPage() {
    ...
    const chats = [
        {
            id: "chat_001",
            name: "Charlene Reed",
            lastMessage: "Is my pet doing better?",
            time: "Just Now",
    ...
    return (
        <div className="space-y-6 pb-12">
            {/* Header / Breadcrumb */}
            <div className="mb-8">
                <h1 className="text-3xl font-black text-[#002B49] mb-1">Messages</h1>
                <nav className="flex items-center gap-2 text-sm text-gray-400">
                    <Link href="/doctor/dashboard" className="hover:text-blue-600 transition">Dashboard</Link>
                    <span>/</span>
                    <span className="text-blue-600/60 font-medium">Messages</span>
                </nav>
            </div>
