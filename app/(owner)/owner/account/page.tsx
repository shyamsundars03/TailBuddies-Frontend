...
function OwnerAccountInner() {
    ...
    const handleSaveAddress = (data: unknown) => {
            ...
            <div className="flex">
                ...
                <aside className="w-56 min-h-screen bg-white shadow-lg pt-6">
                    <nav className="space-y-1 px-3">
                        {[
                            { label: "Profile", href: "/owner/profile", active: false },
                            { label: "Account", href: "/owner/account", active: true },
