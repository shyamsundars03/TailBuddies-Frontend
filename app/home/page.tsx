...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-blue-50 to-blue-100">
      {/* Header */}
      <header className="bg-yellow-400 px-6 py-0 flex items-center justify-between pl-40 pr-40 h-20">
        <div className="flex items-center gap-2">
          <div className="mb-0">
            <Image src="/favicon.ico" alt="TailBuddies Logo" width={100} height={70} priority />
          </div>
        </div>
