    ...
    return (
        <div className="space-y-8 pb-12 font-inter">
            ...
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-2xl font-black text-[#002B49] uppercase tracking-tight">Transaction Ledger</h1>
                    <nav className="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-gray-400 mt-2">
                        ...
                        <span>/</span>
                        <span className="text-blue-600/60 ">{transaction.transactionID}</span>
                    </nav>
                </div>
                <button 
                    onClick={() => router.back()}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    <div className="bg-white rounded-[2.5rem] border border-gray-100 shadow-sm overflow-hidden p-8 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
